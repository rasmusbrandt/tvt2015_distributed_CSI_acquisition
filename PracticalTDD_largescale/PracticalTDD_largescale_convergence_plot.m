...
title(sprintf('Nsim = %d, Pt = %d [dBm], Pr = %d [dBm], Kt = %d, Kc = %d, Mt = %d, Mr = %d, Nd = %d, MS\\_r = %d, BS\\_r = %d',Nsim,Pt_dBm,Pr_dBm,Kt,Kc,Mt,Mr,Nd,MS_robustification,BS_robustification));
